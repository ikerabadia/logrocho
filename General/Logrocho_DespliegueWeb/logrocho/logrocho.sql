...
(6, 'champinones', 2, 2, 'champinones de Pradejon'),
...
(21, 'Muslo de pollo', 4.25, 20, 'Muslo de pollo de la taberna del tio blas, asado a la lena y con patatas'),
...
INSERT INTO `resenas` (`idResena`, `fkUsuario`, `fkPincho`, `nota`, `textoResena`) VALUES
...
(21, 'El bar de los champinones', 'Los champinones mas ricos de todo Logrono, solo aqui en la laurel', 'Calle laurel 78'),
(22, 'Tortillas S.A', 'Tortillas muy buenas solo en nuestro restaurante.\nGanamos un premio el ano pasado', 'Calle laurel 12');
...
--
ALTER TABLE `resenas`
  MODIFY `idResena` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `likes`
  ADD CONSTRAINT `likes_ibfk_1` FOREIGN KEY (`fkResena`) REFERENCES `resenas` (`idResena`) ON DELETE CASCADE ON UPDATE CASCADE,
