    ...
    var numFilas = document.getElementById("itemsPaginacion").value;    
     $.ajax({
        ...
        success: function (response) {
            ...
            var filas = "<tr><th id=\"thId\" onclick=\"orderByIdPinchos()\">ID</th><th id=\"nombrePincho\" onclick=\"orderByNombre()\">Nombre Pincho</th><th id=\"precioPincho\" onclick=\"orderByPrecio()\">Precio</th><th id=\"bar\" onclick=\"orderByBar()\">Bar</th><th id=\"notaMediaPincho\" >Nota media</th><th id=\"cantidadResenasPincho\">Cantidad de Resenas</th><th></th></tr>";
...
LOS DATOS DE LA NOTA MEDIA Y CANTIDAD DE RESEnAS SON CAMPOS CALCULADOS QUE TODAVIA NO TENGO IMPLEMENTADOS 
EN LA API DE PHP POR LO TANTO ESOS DATOS NO VIENEN EN EL JSON CON LOS DATOS POR LO QUE NO SE PUEDE ORDENAR 
SEGUNA LA NOTA MEDIA DE LOS PINCHOS NI POR LA CANTIDAD DE RESEnAS, TODAS LAS DEMAS ORDENACIONES FUNCIONAN PERFECTAMENTE.
