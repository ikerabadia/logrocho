                  ...
                  $.ajax(settings).done(function (response3) {
                    ...
                    var settings = {
                      ...
                      $.ajax(settings).done(function (response2) {
                        ...
                        var textoLike = "";
                        if (resena["likes"] > 0) {
                            textoLike = "<i onclick=\"toogleLike(this, "+resena["idResena"]+")\" class=\"fa fa-heart btnLike\"></i>"
                        }else{
                            textoLike = "<i onclick=\"toogleLike(this, "+resena["idResena"]+")\" class=\"fa fa-heart btnLike fa-heart-o\"></i>"
                        }
                                ...
                                "<div class=\"resena\">"+
                                    "<div class=\"zonaPerfil\">"+
                                        ...
                                        "<div class=\"puntuacion\">"+
                                            "<pp class=\"puntuacionResena\">"+estrellasPuntuacion+"</pp>"+
                                        "</div>"+
                                    "</div>"+               
...
function publicarResena() {
    var textoResena = document.getElementById("inputDescripcionResena").value;

    if (usuario != false) {
        if (/\'/.test(textoResena)) {
            document.getElementById("inputDescripcionResena").style.boxShadow = "0px 0px 10px red";
            document.getElementById("inputDescripcionResena").style.border = "2px solid red";
        }else{
            ...
            var settings = {
              ...
              $.ajax(settings).done(function (response) {
                ...
                document.getElementById("inputDescripcionResena").value = "";
                document.getElementById("inputDescripcionResena").style.boxShadow = "0px 0px 0px black";
                document.getElementById("inputDescripcionResena").style.border = "1px solid black";
                pintarDatos();
              });
        }
    }else{
