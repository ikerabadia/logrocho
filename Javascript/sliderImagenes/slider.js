...
function moverFotoIzquierda(){
    ...
    if (sliderMostrado == "preferidos") {
        ...
        if (img1.classList.contains("mostrado")) {
            ...
            img2.style.backgroundImage = "url(\"imgPinchosFav/"+imagenesPinchosPreferidos[fotoMostrada-1]+".jpg\")";
            ...
            img1.style.backgroundImage = "url(\"imgPinchosFav/"+imagenesPinchosPreferidos[fotoMostrada-1]+".jpg\")";
        ...
        imagen.style.backgroundImage = "url(\"imgPinchosMejorVal/"+imagenesPinchosPreferidos[fotoMostrada-1]+".jpg\")";
...
function mostrarMejorValorados() {
    ...
    btnMejorValorados.style.backgroundColor = "white";
...
function mostrarPreferidos() {
    ...
    btnPreferidos.style.backgroundColor = "white";
