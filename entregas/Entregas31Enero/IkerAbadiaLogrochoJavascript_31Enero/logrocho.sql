...
-- Tiempo de generación: 31-01-2022 a las 14:24:40
...
(15, 'pescados fritos', 8, 15, 'pescaditos pequeñitos fritos'),
...
(15, 'Restaurante11', 'Descripcion restaurante 11', 'Localizacion restaurante 11'),
...
(5, 'javier', 'marin', 'quintana', 'javiermarin@gmail.com', 'javiermarin', 'javiermarin', 0),
...
--
ALTER TABLE `pinchos`
  MODIFY `idPincho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `reseñas`
--
ALTER TABLE `reseñas`
  MODIFY `idReseña` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `restaurantes`
--
ALTER TABLE `restaurantes`
  MODIFY `idRestaurante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
